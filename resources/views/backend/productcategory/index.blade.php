        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary btn-sm me-1" href="{{ route('product-categories.create') }}" title="Sayfa Kategori Ekle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Kategori Ekle
                    </a>
                </div>
                                ...
                                <div class="btn-list flex-nowrap">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item justify-content-between" href="{{ route('product-categories.edit', $item->id) }}" title="Düzenle">

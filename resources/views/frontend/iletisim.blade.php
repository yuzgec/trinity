            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="contact_localtion text-center">
                        ...
                        <h4>Telefon</h4>
                        <p class="mb0">Sabit: <a href="tel:{{ config('settings.telefon1') }}">{{ config('settings.telefon1') }}</a>
                            <br>Mobile: <a href="tel:{{ config('settings.telefon2') }}">{{ config('settings.telefon2') }}</a></p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="contact_localtion text-center">
                        ...
                        <h4>Email</h4>
                        <p> <a href="mailto:{{ config('settings.email1') }}">{{ config('settings.email1') }}</a></p>
                    </div>
                </div>
            </div>
